...
import { TokenResponse, Vehicle, VehicleListResponse, QRCodeResponse } from "./types";
...
export async function generateVehicleQr(vehicleId: string): Promise<QRCodeResponse> {
